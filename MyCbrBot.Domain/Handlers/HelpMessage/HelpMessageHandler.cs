...
Для перевода в рубли можно отправить команду '/convert сумма из_валюты', также можно отправить команды '/convert сумма из_валюты rub' или '/convert сумма из_валюты 840'.
